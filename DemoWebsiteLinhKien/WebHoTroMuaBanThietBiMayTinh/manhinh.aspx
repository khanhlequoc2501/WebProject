<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="manhinh.aspx.cs" Inherits="manhinh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QLLKConnectionString %>" SelectCommand="SELECT * FROM [tbl_SanPham] WHERE ([ML] = @ML)">
        <SelectParameters>
            <asp:Parameter DefaultValue="2" Name="ML" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
